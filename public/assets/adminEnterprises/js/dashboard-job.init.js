var percentCountJob = JSON.parse(
    document.querySelector('meta[name="percentCountJob"]').getAttribute("content")
);

var UnPercentCountJob = JSON.parse(
    document.querySelector('meta[name="UnPercentCountJob"]').getAttribute("content")
);

var percentApplySuccess = JSON.parse(
    document.querySelector('meta[name="percentApplySuccess"]').getAttribute("content")
);

var percentCooperateSuccess = JSON.parse(
    document.querySelector('meta[name="percentCooperateSuccess"]').getAttribute("content")
);

var unPercentCooperate = JSON.parse(
    document.querySelector('meta[name="unPercentCooperate"]').getAttribute("content")
);

var percentWorkshopSuccess = JSON.parse(
    document.querySelector('meta[name="percentWorkshopSuccess"]').getAttribute("content")
);
...
chartRadialbarBasicColors &&
    ...
    (chartRadialbarBasicColors = getChartColorsArray("new_jobs_chart")) &&
        ((options = {
            series: [percentCooperateSuccess],
            chart: {
                type: "radialBar",
                width: 105,
                sparkline: { enabled: !0 },
