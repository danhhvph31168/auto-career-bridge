...
for (let index = 1; index <= 12; index++) {
    month.push(`Tháng ${index}`)
}
let lineChartDashed;
const loadCharts_2 = () => {

    if (lineChartDashed) {
        lineChartDashed.destroy();
    }
            ...
            (linechartDashedColors &&
                ((options = {
                    ...
                    series: [
                        {
                            name: "Ứng tuyển mới",
                            data: countApplyPendingByMonth,
                        },
                        {
                            name: "Ứng tuyển thành công",
                            data: countApplyAcceptByMonth,
                        },
                        {
                            name: "Ứng tuyển bị từ chối",
                            data: countApplyNotAcceptByMonth,
                        },
                    ],
    ...
    // Tạo lại biểu đồ
    lineChartDashed = new ApexCharts(
        document.querySelector("#line_chart_dashed"),
        options
    );

    lineChartDashed.render();
}
...
chartRadialbarBasicColors &&
    ((options = {
        series: [95],
        chart: { type: "radialBar", width: 80, sparkline: { enabled: !0 } },
        dataLabels: { enabled: !1 },
        plotOptions: {
            radialBar: {
    ...
    ((options = {
        series: [acceptWorkshopsPercentage],
        chart: {
            type: "radialBar",
            width: 80,
            sparkline: { enabled: !0 },
