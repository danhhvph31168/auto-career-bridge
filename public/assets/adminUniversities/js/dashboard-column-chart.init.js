var jobTotalMonth = JSON.parse(
    document.querySelector('meta[name="jobTotalMonth"]').getAttribute("content")
);

var cooperateMonth = JSON.parse(
    document
        .querySelector('meta[name="cooperateMonth"]')
        .getAttribute("content")
);

var jobApplyMonth = JSON.parse(
    document.querySelector('meta[name="jobApplyMonth"]').getAttribute("content")
);

var workshopCount = JSON.parse(
    document.querySelector('meta[name="workshopCount"]').getAttribute("content")
);
