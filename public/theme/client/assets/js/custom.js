(function ($) {
	...
	$("#range-slider").slider({
		...
		slide: function (event, ui) {
			$("#price-amount").val(formatPrice(ui.values[0]) + " - " + formatPrice(ui.values[1]));
		}
	});
	$("#price-amount").val(formatPrice($("#range-slider").slider("values", 0)) +
		" - " + formatPrice($("#range-slider").slider("values", 1)));
