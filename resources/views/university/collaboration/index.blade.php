                                        ...
                                        <form id="filterForm" action="" method="GET">
                                            <div class="d-flex justify-content-sm-end">
                                                ...
                                                <div class="search-box ms-2">
                                                    ...
                                                    <a href="{{ route('university.collaborations.index') }}">
                                    ...
                                    <table class="table align-middle table-nowrap" id="customerTable">
                                        <thead class="table-light">
                                            <tr>
                                                ...
                                                <th class="sort" data-sort="name">Tên doanh nghiệp</th>
                                        ...
                                        <tbody class="list form-check-all">
                                            @foreach ($collaborations as $index => $enterprise)
                                                <div class="modal fade" id="showModal{{ $enterprise->id }}" tabindex="-1"
                                                ...
                                                <tr class>
                                                    ...
                                                    <td class="send_name">
                                                        {{ $enterprise->pivot->send_name == TYPE_UNIVERSITY ? 'Bạn' : 'Doanh nghiệp' }}
                                                    </td>
                                                    <td class="start_date">
                                                        {{ \Carbon\Carbon::parse($enterprise->pivot->created_at)->format('d/m/Y') }}
                                                        ({{ now()->diffInDays($enterprise->pivot->created_at) > 0 ? now()->diffInDays($enterprise->pivot->created_at) . ' ngày trước' : 'hôm nay' }})
                                                    </td>
                                                    <td class="d-flex justify-content-center">
                                                        <div class="d-flex gap-2">
                                                            ...
                                                            <div
                                                                class="d-flex gap-2 status_university_{{ $enterprise->id }}">
                                                                @if ($enterprise->pivot->send_name == TYPE_ENTERPRISE)
                                                                    @if ($enterprise->pivot->status == PENDING_APPROVE)
                                                                        <form
                                                                            action="{{ route('university.collaborations.update', $enterprise) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('PUT')
                                                                    ...
                                                                    @endif
                                                                @elseif($enterprise->pivot->send_name == TYPE_UNIVERSITY)
                                                                    @if ($enterprise->pivot->status == PENDING_APPROVE)
                                                                        <form
                                                                            action="{{ route('university.collaborations.destroy', $enterprise) }}"
                                                                            method="post">
                                                                            @csrf
                                                                            @method('DELETE')
                                                                            {{-- <input type="hidden" name="status"
    ...
    <script>
        $(document).ready(function() {
            $(document).on('click', '.btn_modal', function() {
                const universityId = $(this).data('enterprise');
