                                            ...
                                            @php
                                                $cards = [
                                                    [
                                                        ...
                                                        'data_target' => $countWorkshop,
                                                    ],
                                                    [
                                                        'title' => 'Ứng tuyển Workshop',
                                                        'id' => 'apply_jobs',
                                                        'color' => '--vz-success',
                                                        'value' => $applySuccess,
                                                        'counter_class' => 'counter-value',
                                ...
                                <div class="col-xl-6">
                                    <div class="card card-height-100">
                                        ...
                                        <div class="card-header align-items-center d-flex">
                                            <h4 class="card-title mb-0 flex-grow-1">Các workshop nổi bật</h4>
                                            <div class="flex-shrink-0 me-2">
                                                <a href="{{ route('university.exportWorkshop') }}"
                                                    class="btn btn-soft-primary btn-sm material-shadow-none">Xuất File</a>
                                            </div>
                                            <div class="flex-shrink-0">
                                                <a href="{{ route('university.workshop.index') }}"
                                                    class="btn btn-soft-primary btn-sm material-shadow-none">Danh sách Workshop<i
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive table-card">
                                                <table
                                                    ...
                                                    <tbody>
                                                        @foreach ($featuredWorkshop as $item)
                                                            <tr>
                                                                <td>
                                                                    <span
                                                                        class="text-primary">({{ $item->enterprises_count }})</span>
                                                                ...
                                                                <td>
                                                                    <a href="{{ route('university.workshop.show', $item->id) }}"
...
@section('js')
    ...
    <!-- By Date -->
    <script src="{{ asset('assets/adminUniversities/js/dashboardDate.js') }}"></script>

    <!-- Dashboard init -->
    <script src="{{ asset('assets/adminUniversities/js/dashboard-column-chart.init.js') }}"></script>
    <script src="{{ asset('assets/adminUniversities/js/dashboard-job.init.js') }}"></script>
@endsection

@section('meta')
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <meta name="percentCountJob" content="{{ json_encode($percentCountWorkshop) }}">
    ...
    <meta name="percentWorkshopSuccess" content="{{ json_encode($percentJobSuccess) }}">

    <meta name="jobTotalMonth" content="{{ json_encode($workshopTotalMonth) }}">
    <meta name="cooperateMonth" content="{{ json_encode($cooperateMonth) }}">
    <meta name="jobApplyMonth" content="{{ json_encode($workshopApplyMonth) }}">
    <meta name="workshopCount" content="{{ json_encode($jobTotalMonth) }}">
@endsection
