                ...
                <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
                    ...
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Thêm mới giáo vụ</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <form action="{{ route('university.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 left-column">
                                    ...
                                    <p>Điền đầy đủ thông tin dưới đây để thêm mới giáo vụ vào hệ thống.</p>
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#exampleModalFullscreenSm"><i
                                            class="ri-upload-line"></i> Import</button>
                                </div>
                                ...
                                <div class="col-md-8 right-column">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="username" value="{{ old('username') }}" placeholder="Nhập họ tên">
                                                @error('username')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="d-flex">
                                                    <div class="form-check form-radio-outline form-radio-success mt-2">
                                                        <input class="form-check-input" type="radio" name="is_active" id="activeStatus" value="{{ IS_ACTIVE }}" checked>
                                                        <label class="form-check-label" for="activeStatus">
                                                            Hoạt động
                                                        </label>
                                                    </div>
                                                    <div class="form-check form-radio-outline form-radio-danger mt-2 ms-3">
                                                        <input class="form-check-input" type="radio" name="is_active" id="inactiveStatus" value="{{ UN_ACTIVE }}">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control" name="role_id">
                                                    <option value="2" {{ old('role_id') == ROLE_USER ? 'selected' : '' }}>Giáo vụ</option>
                                                </select>
                                                @error('role_id')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                    ...
                                    <div class="d-flex align-items-start gap-3 mt-4">
                                        ...
                                        <button type="submit" class="btn btn-success btn-label right ms-auto">
                                            <i class="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i> Thêm mới
                                        </button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalFullscreenSmLabel">
                    {{ config('admin.enterprise.users.create .import.description') }} 
                </h5>
            ...
            $('.btn_import').on('click', function() {
                ...
                if (jsonData) {
                    $.ajax({
                        ...
                        url: "{{ route('university.importExcelFile') }}",
                        data: JSON.stringify({
                            data: jsonData
                        }),
                        dataType: "json",
                        success: function(res) {
                            if (res.data) {
                                location.href = "{{ route('university.index') }}";
                            }
